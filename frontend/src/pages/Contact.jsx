    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm px-4'>
        <motion.img
          ...
          src={assets.Rockey_Photo}
          alt="Developer Rockey"
        ...
        >
          ...
          <p className=' text-gray-500'>Rockey <br />Indian Institute of Information Technology Guwahati (IIITG)</p>
          <p className=' text-gray-500'>Tel: 9389742196 <br /> Email: rockey@gmail.com</p>
        </motion.div>
      </div>
    </div>
  )
